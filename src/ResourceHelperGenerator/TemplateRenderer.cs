    ...
    internal static class TemplateRenderer
    {
        ...
        public static void RenderTemplate(TextWriter writer, TemplateModel model)
        {
            using (var indentedWriter = new IndentedTextWriter(writer))
            {
                ...
                indentedWriter.WriteUsings("System.Diagnostics", "System.Globalization", "System.Reflection", "System.Resources");
                indentedWriter.WriteEmptyLine();
        ...
        {
            writer.Indent++;
            writer.WriteLine("{0} static class {1}", model.Internalize ? "internal" : "public", model.FileName);
            writer.WriteLine("{");
        ...
        {
            writer.WriteLine(@"private static readonly ResourceManager _resourceManager
        ...
        private static void WriteFormatMethod(this IndentedTextWriter writer, TemplateModel model, ResourceData data)
        {
            ...
            writer.WriteLine("{0} static string {1}({2})", model.Internalize ? "internal" : "public", data.Name, data.Parameters);
            writer.WriteLine("{");
            writer.Indent++;
        ...
        {
            writer.WriteLine("{0} static string {1}", model.Internalize ? "internal" : "public", data.Name);
            writer.WriteLine("{");
            writer.Indent++;
        ...
        private static void WriteGetStringMethod(this IndentedTextWriter writer)
        {
            ...
            writer.WriteLine("{");
            writer.Indent++;
            writer.WriteLine("var value = _resourceManager.GetString(name);");
            writer.WriteEmptyLine();
