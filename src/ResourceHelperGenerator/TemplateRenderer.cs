...
namespace ResourceHelperGenerator
{
    internal static class TemplateRenderer
    {
        ...
        {
            var namespaceIdentifier = GetValidIdentifier(model.ProjectName);

            using (var indentedWriter = new IndentedTextWriter(writer))
            {
                indentedWriter.WriteLine("// <auto-generated />");
                indentedWriter.WriteEmptyLine();
                using (indentedWriter.WriteBlock("namespace {0}", namespaceIdentifier))
                {
        ...
        {
            var identifier = GetValidIdentifier(model.FileName);

            writer.WriteUsings("System", "System.Diagnostics", "System.Globalization", "System.Reflection", "System.Resources");
            writer.WriteEmptyLine();
            using (writer.WriteBlock("{0} static class {1}", model.Internalize ? "internal" : "public", identifier))
            {
        ...
        private static void WriteFormatMethod(this IndentedTextWriter writer, TemplateModel model, ResourceData data)
        {
            ...
            var accessModifier = model.Internalize ? "internal" : "public";

            using (writer.WriteBlock("{0} static string {1}({2})", accessModifier, methodIdentifier, data.Parameters))
            {
        ...
        private static void WriteProperty(this IndentedTextWriter writer, TemplateModel model, ResourceData data)
        {
            ...
            using (writer.WriteBlock("{0} static string {1}", model.Internalize ? "internal" : "public", propertyModifier))
            {
